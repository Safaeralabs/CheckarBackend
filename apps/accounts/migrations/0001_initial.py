    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('customer', 'Cliente'), ('operator', 'Operador'), ('inspector', 'Inspector'), ('supervisor', 'Supervisor'), ('admin', 'Administrador')], default='customer', max_length=32)),
